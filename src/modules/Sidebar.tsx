...
const Sidebar = ({
  ...
  return (
    <aside
      ...
      className="h-screen w-[280px] sm:w-[350px] flex flex-col overflow-hidden"
    >
        ...
        <div className="flex flex-col gap-2 mt-auto">
          <div className="flex gap-2">
            ...
            <button
              ...
              className="text-white px-4 py-2 rounded-full hover:brightness-90 transition whitespace-nowrap"
              onClick={() => {
                if (newChatName.trim()) {
                  onAddChat(newChatName.trim());
                  setNewChatName("");
